$(document).ready(function () {
  ...
  var mySwiper1 = new Swiper('#cnt1 .swiper-container', {
    ...
    on: {
      ...
      slideChangeTransitionStart: function () { //애니메이션이 시작되어 다른 슬라이더로 바뀌기 시작할때
        if ($('#cnt1 .swiper-slide-active').hasClass('black')) {
          $('#cnt1 .controller').addClass('black');
        } else {
  ...
  $(window).on('resize', function () {
    ...
    boxTimer = setTimeout(function() {
      ...
      if (winWid > 1080) {
        ...
        $('#cnt2 ul li').removeAttr('tabIndex class').children().removeAttr('style');
      }
    }, 50);
  });
